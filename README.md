...
Live at **[adjmx.github.io](https://adjmx.github.io)**
...
```ts
const github = user.profile?.nip39Identities?.find((i) => i.platform === 'github')?.identity; // e.g. "macos-node"
```
...
_✦ Claude designed, coded, deployed, debugged & vibed this._
